...
namespace ClubManagement.Utils
{
    public static class MensagemUtils
    {
        ...
        public static bool notificar(int id, string titulo, string mensagem, string audio = null, double velocidade = 0)
        {
            if (_mensagem == null)
                _mensagem = DependencyService.Get<IMensagem>();
            return _mensagem.notificar(id, titulo, mensagem, audio, velocidade);
        }
